...
class GroupReviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create group_review" do
    assert_difference('GroupReview.count') do
      post group_reviews_url, params: { group_review: { category_id: @group_review.category_id, goods_review: @group_review.goods_review, group_id: @group_review.group_id, store_review_id: @group_review.store_review_id, user_id: @group_review.user_id } }
    end
  ...
  test "should update group_review" do
    patch group_review_url(@group_review), params: { group_review: { category_id: @group_review.category_id, goods_review: @group_review.goods_review, group_id: @group_review.group_id, store_review_id: @group_review.store_review_id, user_id: @group_review.user_id } }
